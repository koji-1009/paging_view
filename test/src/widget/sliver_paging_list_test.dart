...
void main() {
  group('SliverPagingList', () {
    ...
    testWidgets('loads more items on scroll (prepend)', (tester) async {
      ...
      await tester.pumpWidget(
        createSliverPagingList(dataSource: dataSource, controller: controller),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('displays append loading widget during append', (tester) async {
      ...
      await tester.pumpWidget(
        createSliverPagingList(dataSource: dataSource, autoLoadAppend: false),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('displays prepend loading widget during prepend', (
      ...
      await tester.pumpWidget(
        createSliverPagingList(dataSource: dataSource, autoLoadPrepend: false),
      );
      await tester.pumpAndSettle();
